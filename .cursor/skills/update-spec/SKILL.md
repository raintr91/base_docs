...
| Load | Do not load |
|------|-------------|
| Target `product/components/CMP-*/code/{W-*,API-*}/{id}.bundle.yaml` — **SSOT** patch | `ir/*.yaml` — regenerated by split |
...
```text
product/components/CMP-*/code/W-*/{id}.bundle.yaml   # patch here
product/components/CMP-*/code/W-*/ir/*.yaml          # read-only — from split
